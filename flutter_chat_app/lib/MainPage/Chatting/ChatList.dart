...
class _ChatList extends State<ChatList> {
  /*------------------ 변수 선언 구문 ------------------*/
  /// Chat List를 불러오는 api
  final _getRoomsData_api =
      ServerData.api + (ServerData.ApiList['/rooms'] as String);
  ...
  Widget _ChatCardeView(width, height, _roomData object) {
    ...
    object.users.forEach((element) {
      _title = _title + element.getName();
    });
      ...
      child: Row(
        children: [
          ...
          Container(
              ...
              child: Image.asset(
                object.users.length > 1
                    ? icon_path
                    : object.users.first.getImage(),
                fit: BoxFit.fill,
              ),
      ...
      body: Column(
        children: <Widget>[
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      ...
                      child: _ChatCardeView(MyProfileWidget_width,
                          MyProfileWidget_height, _roomData()),
                    )),
                  ),
                ],
              ),
          ...
          Container(
              ...
              child: Center(
                child: Container(
                    height: 1, width: rateWidth * 100, color: Colors.black87),
              )),
          Flexible(
            child: ListView(
                  ...
                  for (var item in _Rooms)
                    Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Center(
                            child: _ChatCardeView(FriendProfileWidget_width,
  ...
  void _getRoom() async {
    ...
    final response = await http.get(Uri.parse(_getRoomsData_api), headers: {
    ...
    try {
      print(data);
      for (var item in data) _Rooms.add(new _roomData(item));
    } catch (e) {
      print(e.toString());
    }
  }
  ...
  void _goToChatting(_roomData object) {
    ...
    Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => Chatting(friendsObjs: object.users)));
  }
  /*--------------------------------------------------*/
}
  ...
  _roomData([jsonObj]) {
    if (jsonObj == null) {
      ...
      for (var item in users) {
        ...
        if (temp.parsingData()) {
          if (temp.getName() == myData.getName()) continue;
          users.add(temp);
        } else
          print("error");
      }
